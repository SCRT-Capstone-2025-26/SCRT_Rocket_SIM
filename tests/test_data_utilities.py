...
def test_eng_to_csv():
    eng_src = "../sample_datasets/AeroTech_N2000W.eng"

    spec_true = "../sample_datasets/motor_spec.csv"
    spec_created = "../sample_datasets/motor_spec_test.csv"

    thrust_true = "../sample_datasets/thrust_motor.csv"
    thrust_created = "../sample_datasets/thrust_motor_test.csv"
