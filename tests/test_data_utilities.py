...
def test_read_thrust_data():
    thrust_src = os.path.join(
        os.path.dirname(__file__), "..", "sample_datasets", "thrust_sample.csv"
    )
...
def test_read_eng_thrustfile():
    eng_src = os.path.join(
        os.path.dirname(__file__), "..", "sample_datasets", "AeroTech_N2000W.eng"
    )
...
def test_eng_to_csv():
    ...
    spec_true = os.path.join(
        os.path.dirname(__file__), "..", "sample_datasets", "motor_spec.csv"
    )
    spec_created = os.path.join(
        os.path.dirname(__file__), "..", "sample_datasets", "motor_spec_test.csv"
    )

    thrust_true = os.path.join(
        os.path.dirname(__file__), "..", "sample_datasets", "thrust_motor.csv"
    )
    thrust_created = os.path.join(
        os.path.dirname(__file__), "..", "sample_datasets", "thrust_motor_test.csv"
    )
